...
public class DirectionCosinesLesson02 {
    ...
    public void topicInfo(){
        generateExplanation(topic, "A dextral set of orthogonal unit vectors refers to a set of three vectors that are mutually orthogonal (perpendicular to each other) \n" +
    ...
    public void questionAndAnswer(){
        generateQuestion("Which shape can we derive a dextral set of orthogonal unit vectors from?", "Rectangle",
                "Square","Rectangular prism", "Cube");

        String userAnswer = InputHelper.readLine();
        checkAnswer(userAnswer, "C", "D",
                """
