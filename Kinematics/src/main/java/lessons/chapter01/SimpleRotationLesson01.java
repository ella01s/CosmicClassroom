...
import static functionality.LessonController.*;
import static records.userRecords.UserInfo.getUsername;
import static records.userRecords.UsersRecordUpdater.updateUserLevel;
...
public class SimpleRotationLesson01 {
    ...
    public void topicInfo(){
        generateExplanation(topic, "In simple rotation, points on a rigid object move on circular paths around an axis of rotation.\n" +
    ...
    public void questionAndAnswer(){
        generateQuestion("Which of the following is an example of simple rotation?", "A spinning top spinning in place.",
